...
You can stream your Heroku logs to New Relic using Heroku's built-in [Logplex](https://devcenter.heroku.com/articles/logplex) router. Here it is explained how to stream logs using Heroku [Syslog drains](https://devcenter.heroku.com/articles/log-drains#syslog-drains).
